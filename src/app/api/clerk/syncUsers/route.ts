 ...
 *  'new Response' works in any environment
 *
 *  NextResponse has extra features -
 *  It is used when you need Next.js-specific functionality like:
 *  • Redirects
 *  • Setting cookies
 *  • Rewriting URLs
 *  • Setting custom headers easily
 */
